...
(function load(){
    ...
    for(x in students){
        ...
        <img  id="edit-btn" onclick="edit(${students[x].ID})" src="./assest/pencil-svgrepo-com.png"> <img onclick="deleteStudent(${students[x].ID})" src="./assest/trash-svgrepo-com.png"></td></tr>`
    }
...
function searchStudents(){
    ...
    for(x in filter){
        ...
        <img  id="edit-btn" onclick="edit(${filter[x].ID})" src="./assest/pencil-svgrepo-com.png"> <img onclick="deleteStudent(${filter[x].ID})" src="./assest/trash-svgrepo-com.png"></td></tr>`
    }
